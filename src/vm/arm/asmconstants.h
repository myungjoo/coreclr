...
#define CONTEXT_R4	(0x14)
ASMCONSTANTS_C_ASSERT(CONTEXT_R4 == offsetof(T_CONTEXT,R4))
#define CONTEXT_R5	(CONTEXT_R4 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R5 == offsetof(T_CONTEXT,R5))
#define CONTEXT_R6	(CONTEXT_R5 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R6 == offsetof(T_CONTEXT,R6))
#define CONTEXT_R7	(CONTEXT_R6 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R7 == offsetof(T_CONTEXT,R7))
#define CONTEXT_R8	(CONTEXT_R7 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R8 == offsetof(T_CONTEXT,R8))
#define CONTEXT_R9	(CONTEXT_R8 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R9 == offsetof(T_CONTEXT,R9))
#define CONTEXT_R10	(CONTEXT_R9 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R10 == offsetof(T_CONTEXT,R10))
#define CONTEXT_R11	(CONTEXT_R10 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R11 == offsetof(T_CONTEXT,R11))
#define CONTEXT_R12	(CONTEXT_R11 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_R12 == offsetof(T_CONTEXT,R12))
#define CONTEXT_Sp	(CONTEXT_R12 + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_Sp == offsetof(T_CONTEXT,Sp))
#define CONTEXT_Lr	(CONTEXT_Sp + 4)
ASMCONSTANTS_C_ASSERT(CONTEXT_Lr == offsetof(T_CONTEXT,Lr))
